    ...
    return(
        <div id="apropos"className="fixed top-110 w-full flex flex-col items-center">
			...
			<div className="md:flex top-30 font-montserrat absolute text-left text-white text-2xl justify-center">
				<img src="./src/assets/photo.jpg" className="rounded-full w-1/5 ml-10 md:ml-0 md:w-1/4 h-1/4 mb-4 object-contain"/>
				<div className="flex flex-col md:w-1/4">
					...
					<div className="ml-10 leading-relaxed text-lg">
						<div className="flex items-center">
							<img className="w-1/10 h-auto" src="./src/assets/tel.png"></img>
							<a className="ml-10" href="tel:+33651674638">06.51.67.46.38</a>
						</div>
						<div className="flex items-center">
							<img className="w-1/10 h-auto" src="./src/assets/mail.png"></img>
							<a className="ml-10" href="/contact">bastien.tiffy@epitech.eu</a>
						</div>
						<div className="flex items-center">
							<a href="https://www.linkedin.com/in/bastien-tiffy-34b7a2241/"><img className="w-1/2 h-auto" src="./src/assets/linkedin.png"></img></a>
							<a href="https://github.com/Bastient6"><img className="w-1/2 h-auto" src="./src/assets/github.png" ></img></a>
						</div>
					</div>
				</div>
			</div>					
