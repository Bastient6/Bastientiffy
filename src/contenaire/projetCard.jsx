export default function ProjetCard({link, image, title, description, technos}) {
    return (
        <a href={link}>
            <div className="bg-[#093c67]/25 flex flex-col rounded-xl border p-6 transition transform hover:-translate-y-2 items-center animate-fade-in-up hover:scale-110">
                <img src={image} className="w-24 h-24 mb-4 object-contain"></img>
